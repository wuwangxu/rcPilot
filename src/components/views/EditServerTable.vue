          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="box box-info">
                <el-form :model="tableForm" :rules="rules" ref="tableForm" label-width="100px" class="edit-modalForm">
                  <div class="box-body">
            ...
            <div class="modal-footer">
              ...
              <input type="button" class="btn btn-primary" @click="modify" value="保 存">
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
...
//// str =  str.replace("T"," ");
      ...
      getTableData(){
        if(this.$route.params.tableForm!=null){
          this.tableForm=this.$route.params.tableForm;
          this.tableForm.category=this.tableForm.category+"";
        }else {
          this.$router.push("servertables");
        }
      }
